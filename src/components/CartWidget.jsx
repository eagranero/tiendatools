        ...
        <div>
            ...
            <div tabIndex="0" className="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                <div className="card-body">
                    ...
                    {carrito.map(elem => <div key={elem.detalle.id} style={{display:'flex', flexDireccion:'row', justifyContent:'space-between'}}><p >{elem.detalle.nombre}</p> <p style={{textAlign:"right"}}>{elem.cantidad}</p></div>)}
